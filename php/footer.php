                    ...
                    <div class="footer-column">
                        <div class="footer-header">
                            ...
                            <nav class="level is-mobile">
                                <div class="level-left">
                                    <a class="level-item" href="https://github.com/#">
                                        <span class="icon">
                                            <ion-icon name="logo-github" size="large" role="img" class="md icon-large hydrated" aria-label="logo github"></ion-icon>
                                        </span>
                                    </a>
                                    ...
                                    <a class="level-item" href="https://google.com/#">
                                        <span class="icon">
                                            <ion-icon name="logo-google" size="large" role="img" class="md icon-large hydrated" aria-label="logo google"></ion-icon>
                                        </span>
                                    </a>
                                    <a class="level-item" href="https://linkedin.com/#">
                                        <span class="icon">
                                            <ion-icon name="logo-linkedin" size="large" role="img" class="md icon-large hydrated" aria-label="logo linkedin"></ion-icon>
                                        </span>
                                    </a>
                                </div>
                            </nav>
                            ...
                            <a href="https://bulma.io" target="_blank">
                                <img src="https://appsrv1-147a1.kxcdn.com/bulma-css-fresh/img/logo/made-with-bulma.png" alt="Made with Bulma" width="128" height="24">
                            </a>
                        </div>
                    </div>
                </div>
