...
<?php
	...
	function ft_display_loged()
	{
		...
		{
			// echo "<li class='nav-item'>";
			echo "<a class='navbar-item' href='/tfg_shop/php/admin/admin_header.php'>Admin Page</a>";
			// echo "</li>";
		}
		// echo "<li class='nav-item'>";
		echo "<a class='button is-danger is-dark' href='/tfg_shop/php/functions/logout.php'>Logout</a>";
		// echo "</li>";
	}
